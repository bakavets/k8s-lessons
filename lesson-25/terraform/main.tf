  ...
  worker_groups_launch_template = [
    {
      ...
      ami_id                                   = "ami-00b3d47c1f3493f2d" # Select appropriate and latest AMI for your region https://docs.aws.amazon.com/eks/latest/userguide/eks-optimized-ami.html
...
resource "aws_route53_zone" "k8s_zone" {
  name    = "k8s.bakavets.com"
  
  tags = {
      Type = "Domain Name System Service"
  }
}